...
<tbody>
	...
	<tr>
		...
		<td>Display Total</td>
		<td></td>
		<td style="padding-left: 80px;"><strong>Total</strong></td>
		<td>Display Total</td>
	</tr>
	<tr>
	...
	<tr>
		<td style="padding-left: 35px;">65 & above</td>
	...
	<tr>
		<td style="padding-left: 35px;"><strong>Total</strong></td>
		<td>Display Male Total</td>
		<td>Display Female Total</td>
		<td>Display Total MFT</td>
		<td></td>
		<td style="padding-left: 35px;" colspan="4"><strong>No. of Under 5 Deaths</strong></td>
	</tr>
	<tr>
		<td style="padding-left: 25px;">No. of Senior Citizens (<em>60 yrs. old & above</em>)</td>
	...
	<tr>
		<td style="padding-left: 25px;">No. of Persons with Disabilities</td>
