...
<tbody>
	...
	<tr>
		...
		<td><input type="number" name="age-bracket-male-col-9"></td>
		<td><input type="number" name="age-bracket-female-col-9"></td>
		<td>Display Total</td>
		<td></td>
	...
	<tr>
		...
		<td></td>
		<td><span class="padding-seventy">Male</span></td>
		<td><input type="number" name="no-under-deaths-male"></td>
	</tr>
	<tr>
		<td><span class="padding-fifteen">No. of Persons with Disabilities</span></td>
		<td><input type="number" name="persons-with-disabilities-male"></td>
		<td><input type="number" name="persons-with-disabilities-female"></td>
		<td>Display Total</td>
		<td></td>
		<td><span class="padding-seventy">Female</span></td>
		<td><input type="number" name="no-under-deaths-female"></td>
	</tr>
	<tr>
		<td colspan="4"></td>
		<td></td>
...
<tbody>
	<tr>
		...
		<td></td>
		<td><span class="padding-seventy">Male</span></td>
		<td><input type="number" name="no-fully-immunized-children-male"></td>
	</tr>
	<tr>
		...
		<td></td>
		<td><span class="padding-seventy">Female</span></td>
		<td><input type="number" name="no-fully-immunized-children-female"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td></td>
		<td><span class="padding-seventy">Male</span></td>
		<td><input type="number" name="no-malnourished-children-male"></td>
	</tr>
	<tr>
		...
		<td></td>
		<td><span class="padding-seventy">Female</span></td>
		<td><input type="number" name="no-malnourished-children-female"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td></td>
		<td><span class="padding-seventy">Male</span></td>
		<td><input type="number" name="no-children-no-vaccine-male"></td>
	</tr>
	<tr>
		...
		<td></td>
		<td><span class="padding-seventy">Female</span></td>
		<td><input type="number" name="no-children-no-vaccine-female"></td>
	</tr>
	<tr>
